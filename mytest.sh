...
./cert-tool genserver -d $TESTDIR1 -p hallo --hostname "lesch.suse.de" --state Bavaria --city Nuremberg --org "SUSE LLC" --email "suse@suse.com" --country "DE" -v --bits 4096 --cert-expiration 700 --md sha512 --cname "www.suse.de" --cname "w3.suse.de" || error
